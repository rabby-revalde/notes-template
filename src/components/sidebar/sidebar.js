...
import bmBurger from "../../images/Icon-ionic-ios-menu.svg"
  ...
  render() {
    ...
    return (
      <SideBar
        ...
        styles={{
          sidebar: {
            background: "linear-gradient(76deg, #00088c 0%, #3983ff)",
            width: "300px",
            position: "fixed",
            zIndex: "3",
          },
      ...
      >
        <div className="bm-burger-button float-right text-white">
          <img
